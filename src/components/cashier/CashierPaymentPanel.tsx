...
import { Banknote, CreditCard, Check, Printer, ChevronDown, ChevronUp, SplitSquareHorizontal, Users, Landmark, Percent } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full bg-card">
      ...
      <div className="px-5 py-4 border-b shrink-0 flex items-center justify-between">
        ...
        {order.status === 'active' && onMarkReady && (
